...
[![tabler-icons-version](https://img.shields.io/badge/Tabler%20Icons-v3.2.0-%23206bc4?style=flat-square)](https://tabler.io/icons)
...
This version includes **Tabler Icons v3.2.0**, see [changelog](https://tabler.io/icons/changelog) to know which icons are available.
