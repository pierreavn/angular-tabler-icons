...
[![tabler-icons-version](https://img.shields.io/badge/Tabler%20Icons-v2.41.0-%23206bc4?style=flat-square)](https://tabler-icons.io)
...
This version includes **Tabler Icons v2.41.0**, see [changelog](https://tabler-icons.io/changelog) to know which icons are available.
